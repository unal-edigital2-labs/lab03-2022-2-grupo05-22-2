...
class BaseSoC(SoCCore):
	def __init__(self):
		...
		platform.add_source("module/verilog/servo_p.v")
		platform.add_source("module/verilog/temperatura.v")
		platform.add_source("module/verilog/Valvula.v")
		platform.add_source("module/verilog/MQ3.v")
		platform.add_source("module/verilog/Nivel_agua.v")
...
# 			cpu_type="picorv32",
		...
		self.submodules.servo_cntrl = module_verilog.ServoVerilog(platform.request("servo_n",1))
		
		SoCCore.add_csr(self,"temp_signal")
		self.submodules.temp_signal = module_verilog.TempVerilog(platform.request("temp_n",1))
		
		SoCCore.add_csr(self,"valvula_cntrl")
		self.submodules.valvula_cntrl = module_verilog.ValVerilog(platform.request("valvula_pin",1))
		
		SoCCore.add_csr(self,"MQ3_signal")
		self.submodules.MQ3_signal = module_verilog.MQ3Verilog(platform.request("MQ3_pin",1))
		
		SoCCore.add_csr(self,"Nivel_sig")
		self.submodules.Nivel_sig= Nivel.NivelVerilog(platform.request("Nivel_pin",1))										
