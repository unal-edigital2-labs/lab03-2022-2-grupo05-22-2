...
module top (
	...
	output reg  pwm__1,
	output wire servo_n1_servo_o,
	inout  wire temp_n1_data_temp,
	output wire valvula_pin1_sal_val,
	input  wire MQ3_pin1_Alcohol_ent,
	input  wire Nivel_pin1_Ent_nivel0,
	input  wire Nivel_pin1_Ent_nivel1,
	output wire mod_pin_verilog1_xclk,
	output wire mod_pin_verilog1_salida_led
);
...
reg  PWM_enable_storage = 1'd0;
reg  PWM_enable_re = 1'd0;
reg  [31:0] PWM_width_storage = 32'd0;
reg  PWM_width_re = 1'd0;
reg  [31:0] PWM_period_storage = 32'd0;
reg  PWM_period_re = 1'd0;
reg  [1:0] servo_cntrl_storage = 2'd0;
reg  servo_cntrl_re = 1'd0;
wire [15:0] temp_signal_status;
wire temp_signal_we;
reg  temp_signal_re = 1'd0;
reg  valvula_cntrl_storage = 1'd0;
reg  valvula_cntrl_re = 1'd0;
wire MQ3_signal_status;
wire MQ3_signal_we;
reg  MQ3_signal_re = 1'd0;
wire Sal_nivel1_status;
wire Sal_nivel1_we;
reg  Sal_nivel1_re = 1'd0;
wire Sal_nivel_temp_status;
wire Sal_nivel_temp_we;
reg  Sal_nivel_temp_re = 1'd0;
wire GPIOverilog_cntrl_done_status;
wire GPIOverilog_cntrl_done_we;
reg  GPIOverilog_cntrl_done_re = 1'd0;
reg  GPIOverilog_cntrl_valor_led_storage = 1'd0;
reg  GPIOverilog_cntrl_valor_led_re = 1'd0;
wire GPIOverilog_cntrl_irq;
wire GPIOverilog_cntrl_ok_status;
reg  GPIOverilog_cntrl_ok_pending = 1'd0;
reg  GPIOverilog_cntrl_ok_trigger = 1'd0;
reg  GPIOverilog_cntrl_ok_clear = 1'd0;
reg  GPIOverilog_cntrl_ok_trigger_d = 1'd0;
wire GPIOverilog_cntrl_ok0;
wire GPIOverilog_cntrl_status_status;
wire GPIOverilog_cntrl_status_we;
reg  GPIOverilog_cntrl_status_re = 1'd0;
wire GPIOverilog_cntrl_ok1;
wire GPIOverilog_cntrl_pending_status;
wire GPIOverilog_cntrl_pending_we;
reg  GPIOverilog_cntrl_pending_re = 1'd0;
reg  GPIOverilog_cntrl_pending_r = 1'd0;
wire GPIOverilog_cntrl_ok2;
reg  GPIOverilog_cntrl_enable_storage = 1'd0;
reg  GPIOverilog_cntrl_enable_re = 1'd0;
...
reg  csrbank0_valor_led0_re = 1'd0;
wire csrbank0_valor_led0_r;
reg  csrbank0_valor_led0_we = 1'd0;
wire csrbank0_valor_led0_w;
...
reg  csrbank1_Alcohol_sal_re = 1'd0;
wire csrbank1_Alcohol_sal_r;
reg  csrbank1_Alcohol_sal_we = 1'd0;
wire csrbank1_Alcohol_sal_w;
wire csrbank1_sel;
wire [13:0] interface2_bank_bus_adr;
wire interface2_bank_bus_we;
wire [31:0] interface2_bank_bus_dat_w;
reg  [31:0] interface2_bank_bus_dat_r = 32'd0;
reg  csrbank2_Sal_nivel1_re = 1'd0;
wire csrbank2_Sal_nivel1_r;
reg  csrbank2_Sal_nivel1_we = 1'd0;
wire csrbank2_Sal_nivel1_w;
reg  csrbank2_Sal_nivel_temp_re = 1'd0;
wire csrbank2_Sal_nivel_temp_r;
reg  csrbank2_Sal_nivel_temp_we = 1'd0;
wire csrbank2_Sal_nivel_temp_w;
wire csrbank2_sel;
...
reg  csrbank3_width0_re = 1'd0;
wire [31:0] csrbank3_width0_r;
reg  csrbank3_width0_we = 1'd0;
wire [31:0] csrbank3_width0_w;
reg  csrbank3_period0_re = 1'd0;
wire [31:0] csrbank3_period0_r;
reg  csrbank3_period0_we = 1'd0;
wire [31:0] csrbank3_period0_w;
wire csrbank3_sel;
wire [13:0] interface4_bank_bus_adr;
wire interface4_bank_bus_we;
wire [31:0] interface4_bank_bus_dat_w;
reg  [31:0] interface4_bank_bus_dat_r = 32'd0;
reg  csrbank4_in_re = 1'd0;
wire [2:0] csrbank4_in_r;
reg  csrbank4_in_we = 1'd0;
wire [2:0] csrbank4_in_w;
wire csrbank4_sel;
wire [13:0] interface5_bank_bus_adr;
wire interface5_bank_bus_we;
wire [31:0] interface5_bank_bus_dat_w;
reg  [31:0] interface5_bank_bus_dat_r = 32'd0;
reg  csrbank5_reset0_re = 1'd0;
wire [1:0] csrbank5_reset0_r;
reg  csrbank5_reset0_we = 1'd0;
wire [1:0] csrbank5_reset0_w;
reg  csrbank5_scratch0_re = 1'd0;
wire [31:0] csrbank5_scratch0_r;
reg  csrbank5_scratch0_we = 1'd0;
wire [31:0] csrbank5_scratch0_w;
reg  csrbank5_bus_errors_re = 1'd0;
wire [31:0] csrbank5_bus_errors_r;
reg  csrbank5_bus_errors_we = 1'd0;
wire [31:0] csrbank5_bus_errors_w;
wire csrbank5_sel;
...
wire [2:0] csrbank7_out0_r;
reg  csrbank7_out0_we = 1'd0;
wire [2:0] csrbank7_out0_w;
wire csrbank7_sel;
...
reg  csrbank8_pos0_re = 1'd0;
wire [1:0] csrbank8_pos0_r;
reg  csrbank8_pos0_we = 1'd0;
wire [1:0] csrbank8_pos0_w;
wire csrbank8_sel;
...
wire [3:0] csrbank9_in_r;
reg  csrbank9_in_we = 1'd0;
wire [3:0] csrbank9_in_w;
wire csrbank9_sel;
...
reg  csrbank10_temperature_re = 1'd0;
wire [15:0] csrbank10_temperature_r;
reg  csrbank10_temperature_we = 1'd0;
wire [15:0] csrbank10_temperature_w;
wire csrbank10_sel;
...
reg  csrbank11_load0_re = 1'd0;
wire [31:0] csrbank11_load0_r;
reg  csrbank11_load0_we = 1'd0;
wire [31:0] csrbank11_load0_w;
reg  csrbank11_reload0_re = 1'd0;
wire [31:0] csrbank11_reload0_r;
reg  csrbank11_reload0_we = 1'd0;
wire [31:0] csrbank11_reload0_w;
reg  csrbank11_en0_re = 1'd0;
wire csrbank11_en0_r;
reg  csrbank11_en0_we = 1'd0;
wire csrbank11_en0_w;
reg  csrbank11_update_value0_re = 1'd0;
wire csrbank11_update_value0_r;
reg  csrbank11_update_value0_we = 1'd0;
wire csrbank11_update_value0_w;
reg  csrbank11_value_re = 1'd0;
wire [31:0] csrbank11_value_r;
reg  csrbank11_value_we = 1'd0;
wire [31:0] csrbank11_value_w;
...
reg  csrbank12_txfull_re = 1'd0;
wire csrbank12_txfull_r;
reg  csrbank12_txfull_we = 1'd0;
wire csrbank12_txfull_w;
reg  csrbank12_rxempty_re = 1'd0;
wire csrbank12_rxempty_r;
reg  csrbank12_rxempty_we = 1'd0;
wire csrbank12_rxempty_w;
reg  csrbank12_ev_status_re = 1'd0;
wire [1:0] csrbank12_ev_status_r;
reg  csrbank12_ev_status_we = 1'd0;
wire [1:0] csrbank12_ev_status_w;
reg  csrbank12_ev_pending_re = 1'd0;
wire [1:0] csrbank12_ev_pending_r;
reg  csrbank12_ev_pending_we = 1'd0;
wire [1:0] csrbank12_ev_pending_w;
...
reg  csrbank12_txempty_re = 1'd0;
wire csrbank12_txempty_r;
reg  csrbank12_txempty_we = 1'd0;
wire csrbank12_txempty_w;
reg  csrbank12_rxfull_re = 1'd0;
wire csrbank12_rxfull_r;
reg  csrbank12_rxfull_we = 1'd0;
wire csrbank12_rxfull_w;
wire csrbank12_sel;
...
reg  csrbank13_control_sig0_re = 1'd0;
wire csrbank13_control_sig0_r;
reg  csrbank13_control_sig0_we = 1'd0;
wire csrbank13_control_sig0_w;
wire csrbank13_sel;
...
assign {led2, led1, led0} = leds_storage;
assign GPIOverilog_cntrl_ok0 = GPIOverilog_cntrl_ok_status;
assign GPIOverilog_cntrl_ok1 = GPIOverilog_cntrl_ok_pending;
always @(*) begin
	GPIOverilog_cntrl_ok_clear <= 1'd0;
	if ((GPIOverilog_cntrl_pending_re & GPIOverilog_cntrl_pending_r)) begin
		GPIOverilog_cntrl_ok_clear <= 1'd1;
	end
end
assign GPIOverilog_cntrl_irq = (GPIOverilog_cntrl_pending_status & GPIOverilog_cntrl_enable_storage);
assign GPIOverilog_cntrl_ok_status = GPIOverilog_cntrl_ok_trigger;
always @(*) begin
	basesoc_adr <= 14'd0;
	basesoc_we <= 1'd0;
	basesoc_dat_w <= 32'd0;
...
always @(*) begin
	...
	if ((csrbank0_sel & (interface0_bank_bus_adr[8:0] == 1'd0))) begin
		...
		csrbank0_done_we <= (~interface0_bank_bus_we);
	end
end
assign csrbank0_valor_led0_r = interface0_bank_bus_dat_w[0];
always @(*) begin
	csrbank0_valor_led0_we <= 1'd0;
	csrbank0_valor_led0_re <= 1'd0;
	if ((csrbank0_sel & (interface0_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank0_valor_led0_re <= interface0_bank_bus_we;
		csrbank0_valor_led0_we <= (~interface0_bank_bus_we);
	end
end
...
assign csrbank0_done_w = GPIOverilog_cntrl_done_status;
assign GPIOverilog_cntrl_done_we = csrbank0_done_we;
assign csrbank0_valor_led0_w = GPIOverilog_cntrl_valor_led_storage;
assign GPIOverilog_cntrl_status_status = GPIOverilog_cntrl_ok0;
assign csrbank0_ev_status_w = GPIOverilog_cntrl_status_status;
assign GPIOverilog_cntrl_status_we = csrbank0_ev_status_we;
assign GPIOverilog_cntrl_pending_status = GPIOverilog_cntrl_ok1;
assign csrbank0_ev_pending_w = GPIOverilog_cntrl_pending_status;
assign GPIOverilog_cntrl_pending_we = csrbank0_ev_pending_we;
assign GPIOverilog_cntrl_ok2 = GPIOverilog_cntrl_enable_storage;
assign csrbank0_ev_enable0_w = GPIOverilog_cntrl_enable_storage;
assign csrbank1_sel = (interface1_bank_bus_adr[13:9] == 4'd8);
assign csrbank1_Alcohol_sal_r = interface1_bank_bus_dat_w[0];
always @(*) begin
	csrbank1_Alcohol_sal_re <= 1'd0;
	csrbank1_Alcohol_sal_we <= 1'd0;
	if ((csrbank1_sel & (interface1_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank1_Alcohol_sal_re <= interface1_bank_bus_we;
		csrbank1_Alcohol_sal_we <= (~interface1_bank_bus_we);
	end
end
assign csrbank1_Alcohol_sal_w = MQ3_signal_status;
assign MQ3_signal_we = csrbank1_Alcohol_sal_we;
assign csrbank2_sel = (interface2_bank_bus_adr[13:9] == 4'd9);
assign csrbank2_Sal_nivel1_r = interface2_bank_bus_dat_w[0];
always @(*) begin
	csrbank2_Sal_nivel1_re <= 1'd0;
	csrbank2_Sal_nivel1_we <= 1'd0;
	if ((csrbank2_sel & (interface2_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank2_Sal_nivel1_re <= interface2_bank_bus_we;
		csrbank2_Sal_nivel1_we <= (~interface2_bank_bus_we);
	end
end
assign csrbank2_Sal_nivel_temp_r = interface2_bank_bus_dat_w[0];
always @(*) begin
	csrbank2_Sal_nivel_temp_we <= 1'd0;
	csrbank2_Sal_nivel_temp_re <= 1'd0;
	if ((csrbank2_sel & (interface2_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank2_Sal_nivel_temp_re <= interface2_bank_bus_we;
		csrbank2_Sal_nivel_temp_we <= (~interface2_bank_bus_we);
	end
end
assign csrbank2_Sal_nivel1_w = Sal_nivel1_status;
assign Sal_nivel1_we = csrbank2_Sal_nivel1_we;
assign csrbank2_Sal_nivel_temp_w = Sal_nivel_temp_status;
assign Sal_nivel_temp_we = csrbank2_Sal_nivel_temp_we;
...
assign csrbank3_width0_r = interface3_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank3_width0_we <= 1'd0;
	csrbank3_width0_re <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank3_width0_re <= interface3_bank_bus_we;
		csrbank3_width0_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_period0_r = interface3_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank3_period0_re <= 1'd0;
	csrbank3_period0_we <= 1'd0;
	if ((csrbank3_sel & (interface3_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank3_period0_re <= interface3_bank_bus_we;
		csrbank3_period0_we <= (~interface3_bank_bus_we);
	end
end
assign csrbank3_enable0_w = PWM_enable_storage;
assign csrbank3_width0_w = PWM_width_storage[31:0];
assign csrbank3_period0_w = PWM_period_storage[31:0];
assign csrbank4_sel = (interface4_bank_bus_adr[13:9] == 2'd2);
assign csrbank4_in_r = interface4_bank_bus_dat_w[2:0];
always @(*) begin
	csrbank4_in_re <= 1'd0;
	csrbank4_in_we <= 1'd0;
	if ((csrbank4_sel & (interface4_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank4_in_re <= interface4_bank_bus_we;
		csrbank4_in_we <= (~interface4_bank_bus_we);
	end
end
assign csrbank4_in_w = buttons_status[2:0];
assign buttons_we = csrbank4_in_we;
assign csrbank5_sel = (interface5_bank_bus_adr[13:9] == 4'd11);
assign csrbank5_reset0_r = interface5_bank_bus_dat_w[1:0];
always @(*) begin
	csrbank5_reset0_re <= 1'd0;
	csrbank5_reset0_we <= 1'd0;
	if ((csrbank5_sel & (interface5_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank5_reset0_re <= interface5_bank_bus_we;
		csrbank5_reset0_we <= (~interface5_bank_bus_we);
	end
end
assign csrbank5_scratch0_r = interface5_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank5_scratch0_re <= 1'd0;
	csrbank5_scratch0_we <= 1'd0;
	if ((csrbank5_sel & (interface5_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank5_scratch0_re <= interface5_bank_bus_we;
		csrbank5_scratch0_we <= (~interface5_bank_bus_we);
	end
end
assign csrbank5_bus_errors_r = interface5_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank5_bus_errors_we <= 1'd0;
	csrbank5_bus_errors_re <= 1'd0;
	if ((csrbank5_sel & (interface5_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank5_bus_errors_re <= interface5_bank_bus_we;
		csrbank5_bus_errors_we <= (~interface5_bank_bus_we);
	end
end
always @(*) begin
	soc_rst <= 1'd0;
...
assign csrbank5_reset0_w = reset_storage[1:0];
assign csrbank5_scratch0_w = scratch_storage[31:0];
assign csrbank5_bus_errors_w = bus_errors_status[31:0];
assign bus_errors_we = csrbank5_bus_errors_we;
...
assign csrbank6_r_enable0_w = r_enable_storage;
assign csrbank6_r_width0_w = r_width_storage[31:0];
assign csrbank6_r_period0_w = r_period_storage[31:0];
assign csrbank6_g_enable0_w = g_enable_storage;
assign csrbank6_g_width0_w = g_width_storage[31:0];
assign csrbank6_g_period0_w = g_period_storage[31:0];
assign csrbank6_b_enable0_w = b_enable_storage;
assign csrbank6_b_width0_w = b_width_storage[31:0];
assign csrbank6_b_period0_w = b_period_storage[31:0];
assign csrbank7_sel = (interface7_bank_bus_adr[13:9] == 1'd0);
assign csrbank7_out0_r = interface7_bank_bus_dat_w[2:0];
always @(*) begin
...
assign csrbank7_out0_w = leds_storage[2:0];
assign csrbank8_sel = (interface8_bank_bus_adr[13:9] == 3'd5);
assign csrbank8_pos0_r = interface8_bank_bus_dat_w[1:0];
always @(*) begin
	csrbank8_pos0_we <= 1'd0;
	csrbank8_pos0_re <= 1'd0;
	if ((csrbank8_sel & (interface8_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank8_pos0_re <= interface8_bank_bus_we;
		csrbank8_pos0_we <= (~interface8_bank_bus_we);
	end
end
assign csrbank8_pos0_w = servo_cntrl_storage[1:0];
assign csrbank9_sel = (interface9_bank_bus_adr[13:9] == 1'd1);
assign csrbank9_in_r = interface9_bank_bus_dat_w[3:0];
always @(*) begin
	csrbank9_in_we <= 1'd0;
	csrbank9_in_re <= 1'd0;
...
assign csrbank9_in_w = switchs_status[3:0];
assign switchs_we = csrbank9_in_we;
assign csrbank10_sel = (interface10_bank_bus_adr[13:9] == 3'd6);
assign csrbank10_temperature_r = interface10_bank_bus_dat_w[15:0];
always @(*) begin
	csrbank10_temperature_we <= 1'd0;
	csrbank10_temperature_re <= 1'd0;
	if ((csrbank10_sel & (interface10_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank10_temperature_re <= interface10_bank_bus_we;
		csrbank10_temperature_we <= (~interface10_bank_bus_we);
	end
end
assign csrbank10_temperature_w = temp_signal_status[15:0];
assign temp_signal_we = csrbank10_temperature_we;
assign csrbank11_sel = (interface11_bank_bus_adr[13:9] == 4'd12);
assign csrbank11_load0_r = interface11_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank11_load0_we <= 1'd0;
	csrbank11_load0_re <= 1'd0;
	if ((csrbank11_sel & (interface11_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank11_load0_re <= interface11_bank_bus_we;
		csrbank11_load0_we <= (~interface11_bank_bus_we);
	end
end
assign csrbank11_reload0_r = interface11_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank11_reload0_re <= 1'd0;
	csrbank11_reload0_we <= 1'd0;
	if ((csrbank11_sel & (interface11_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank11_reload0_re <= interface11_bank_bus_we;
		csrbank11_reload0_we <= (~interface11_bank_bus_we);
	end
end
assign csrbank11_en0_r = interface11_bank_bus_dat_w[0];
always @(*) begin
	csrbank11_en0_we <= 1'd0;
	csrbank11_en0_re <= 1'd0;
	if ((csrbank11_sel & (interface11_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank11_en0_re <= interface11_bank_bus_we;
		csrbank11_en0_we <= (~interface11_bank_bus_we);
	end
end
assign csrbank11_update_value0_r = interface11_bank_bus_dat_w[0];
always @(*) begin
	csrbank11_update_value0_re <= 1'd0;
	csrbank11_update_value0_we <= 1'd0;
	if ((csrbank11_sel & (interface11_bank_bus_adr[8:0] == 2'd3))) begin
		csrbank11_update_value0_re <= interface11_bank_bus_we;
		csrbank11_update_value0_we <= (~interface11_bank_bus_we);
	end
end
assign csrbank11_value_r = interface11_bank_bus_dat_w[31:0];
always @(*) begin
	csrbank11_value_re <= 1'd0;
	csrbank11_value_we <= 1'd0;
	if ((csrbank11_sel & (interface11_bank_bus_adr[8:0] == 3'd4))) begin
		csrbank11_value_re <= interface11_bank_bus_we;
		csrbank11_value_we <= (~interface11_bank_bus_we);
	end
end
...
assign csrbank11_load0_w = timer_load_storage[31:0];
assign csrbank11_reload0_w = timer_reload_storage[31:0];
assign csrbank11_en0_w = timer_en_storage;
assign csrbank11_update_value0_w = timer_update_value_storage;
assign csrbank11_value_w = timer_value_status[31:0];
assign timer_value_we = csrbank11_value_we;
assign timer_status_status = timer_zero0;
assign csrbank11_ev_status_w = timer_status_status;
assign timer_status_we = csrbank11_ev_status_we;
assign timer_pending_status = timer_zero1;
assign csrbank11_ev_pending_w = timer_pending_status;
assign timer_pending_we = csrbank11_ev_pending_we;
assign timer_zero2 = timer_enable_storage;
assign csrbank11_ev_enable0_w = timer_enable_storage;
assign csrbank12_sel = (interface12_bank_bus_adr[13:9] == 4'd13);
assign uart_rxtx_r = interface12_bank_bus_dat_w[7:0];
always @(*) begin
	uart_rxtx_we <= 1'd0;
	uart_rxtx_re <= 1'd0;
	if ((csrbank12_sel & (interface12_bank_bus_adr[8:0] == 1'd0))) begin
		uart_rxtx_re <= interface12_bank_bus_we;
		uart_rxtx_we <= (~interface12_bank_bus_we);
	end
end
assign csrbank12_txfull_r = interface12_bank_bus_dat_w[0];
always @(*) begin
	csrbank12_txfull_we <= 1'd0;
	csrbank12_txfull_re <= 1'd0;
	if ((csrbank12_sel & (interface12_bank_bus_adr[8:0] == 1'd1))) begin
		csrbank12_txfull_re <= interface12_bank_bus_we;
		csrbank12_txfull_we <= (~interface12_bank_bus_we);
	end
end
assign csrbank12_rxempty_r = interface12_bank_bus_dat_w[0];
always @(*) begin
	csrbank12_rxempty_we <= 1'd0;
	csrbank12_rxempty_re <= 1'd0;
	if ((csrbank12_sel & (interface12_bank_bus_adr[8:0] == 2'd2))) begin
		csrbank12_rxempty_re <= interface12_bank_bus_we;
		csrbank12_rxempty_we <= (~interface12_bank_bus_we);
	end
end
assign csrbank12_ev_status_r = interface12_bank_bus_dat_w[1:0];
always @(*) begin
...
assign csrbank12_ev_pending_r = interface12_bank_bus_dat_w[1:0];
always @(*) begin
...
assign csrbank12_txempty_r = interface12_bank_bus_dat_w[0];
always @(*) begin
	csrbank12_txempty_re <= 1'd0;
	csrbank12_txempty_we <= 1'd0;
	if ((csrbank12_sel & (interface12_bank_bus_adr[8:0] == 3'd6))) begin
		csrbank12_txempty_re <= interface12_bank_bus_we;
		csrbank12_txempty_we <= (~interface12_bank_bus_we);
	end
end
assign csrbank12_rxfull_r = interface12_bank_bus_dat_w[0];
always @(*) begin
	csrbank12_rxfull_re <= 1'd0;
	csrbank12_rxfull_we <= 1'd0;
	if ((csrbank12_sel & (interface12_bank_bus_adr[8:0] == 3'd7))) begin
		csrbank12_rxfull_re <= interface12_bank_bus_we;
		csrbank12_rxfull_we <= (~interface12_bank_bus_we);
	end
end
assign csrbank12_txfull_w = uart_txfull_status;
assign uart_txfull_we = csrbank12_txfull_we;
assign csrbank12_rxempty_w = uart_rxempty_status;
assign uart_rxempty_we = csrbank12_rxempty_we;
always @(*) begin
	uart_status_status <= 2'd0;
	uart_status_status[0] <= uart_tx0;
	uart_status_status[1] <= uart_rx0;
end
assign csrbank12_ev_status_w = uart_status_status[1:0];
assign uart_status_we = csrbank12_ev_status_we;
always @(*) begin
	uart_pending_status <= 2'd0;
	uart_pending_status[0] <= uart_tx1;
	uart_pending_status[1] <= uart_rx1;
end
assign csrbank12_ev_pending_w = uart_pending_status[1:0];
assign uart_pending_we = csrbank12_ev_pending_we;
assign uart_tx2 = uart_enable_storage[0];
assign uart_rx2 = uart_enable_storage[1];
assign csrbank12_ev_enable0_w = uart_enable_storage[1:0];
assign csrbank12_txempty_w = uart_txempty_status;
assign uart_txempty_we = csrbank12_txempty_we;
assign csrbank12_rxfull_w = uart_rxfull_status;
assign uart_rxfull_we = csrbank12_rxfull_we;
assign csrbank13_sel = (interface13_bank_bus_adr[13:9] == 3'd7);
assign csrbank13_control_sig0_r = interface13_bank_bus_dat_w[0];
always @(*) begin
	csrbank13_control_sig0_re <= 1'd0;
	csrbank13_control_sig0_we <= 1'd0;
	if ((csrbank13_sel & (interface13_bank_bus_adr[8:0] == 1'd0))) begin
		csrbank13_control_sig0_re <= interface13_bank_bus_we;
		csrbank13_control_sig0_we <= (~interface13_bank_bus_we);
	end
end
assign csrbank13_control_sig0_w = valvula_cntrl_storage;
...
assign PWM_enable = PWM_enable_storage;
assign PWM_width = PWM_width_storage;
assign PWM_period = PWM_period_storage;
...
always @(posedge sys_clk) begin
	...
	if (GPIOverilog_cntrl_ok_clear) begin
		GPIOverilog_cntrl_ok_pending <= 1'd0;
	end
	GPIOverilog_cntrl_ok_trigger_d <= GPIOverilog_cntrl_ok_trigger;
	if (((~GPIOverilog_cntrl_ok_trigger) & GPIOverilog_cntrl_ok_trigger_d)) begin
		GPIOverilog_cntrl_ok_pending <= 1'd1;
	end
	...
	if (csrbank0_sel) begin
		case (interface0_bank_bus_adr[8:0])
			...
			1'd1: begin
				interface0_bank_bus_dat_r <= csrbank0_valor_led0_w;
			end
			2'd2: begin
	...
	GPIOverilog_cntrl_done_re <= csrbank0_done_re;
	if (csrbank0_valor_led0_re) begin
		GPIOverilog_cntrl_valor_led_storage <= csrbank0_valor_led0_r;
	end
	GPIOverilog_cntrl_valor_led_re <= csrbank0_valor_led0_re;
	GPIOverilog_cntrl_status_re <= csrbank0_ev_status_re;
	if (csrbank0_ev_pending_re) begin
		GPIOverilog_cntrl_pending_r <= csrbank0_ev_pending_r;
	end
	GPIOverilog_cntrl_pending_re <= csrbank0_ev_pending_re;
	if (csrbank0_ev_enable0_re) begin
		GPIOverilog_cntrl_enable_storage <= csrbank0_ev_enable0_r;
	end
	GPIOverilog_cntrl_enable_re <= csrbank0_ev_enable0_re;
	interface1_bank_bus_dat_r <= 1'd0;
	if (csrbank1_sel) begin
		case (interface1_bank_bus_adr[8:0])
			1'd0: begin
				interface1_bank_bus_dat_r <= csrbank1_Alcohol_sal_w;
			end
		endcase
	end
	MQ3_signal_re <= csrbank1_Alcohol_sal_re;
	interface2_bank_bus_dat_r <= 1'd0;
	if (csrbank2_sel) begin
		case (interface2_bank_bus_adr[8:0])
			1'd0: begin
				interface2_bank_bus_dat_r <= csrbank2_Sal_nivel1_w;
			end
			1'd1: begin
				interface2_bank_bus_dat_r <= csrbank2_Sal_nivel_temp_w;
			end
		endcase
	end
	Sal_nivel1_re <= csrbank2_Sal_nivel1_re;
	Sal_nivel_temp_re <= csrbank2_Sal_nivel_temp_re;
	...
	if (csrbank3_sel) begin
		case (interface3_bank_bus_adr[8:0])
			...
			1'd1: begin
				interface3_bank_bus_dat_r <= csrbank3_width0_w;
			end
			2'd2: begin
				interface3_bank_bus_dat_r <= csrbank3_period0_w;
			end
		endcase
	end
	if (csrbank3_enable0_re) begin
		PWM_enable_storage <= csrbank3_enable0_r;
	end
	PWM_enable_re <= csrbank3_enable0_re;
	if (csrbank3_width0_re) begin
		PWM_width_storage[31:0] <= csrbank3_width0_r;
	end
	PWM_width_re <= csrbank3_width0_re;
	if (csrbank3_period0_re) begin
		PWM_period_storage[31:0] <= csrbank3_period0_r;
	end
	PWM_period_re <= csrbank3_period0_re;
	...
	buttons_re <= csrbank4_in_re;
	interface5_bank_bus_dat_r <= 1'd0;
	if (csrbank5_sel) begin
		case (interface5_bank_bus_adr[8:0])
			1'd0: begin
				interface5_bank_bus_dat_r <= csrbank5_reset0_w;
			end
			1'd1: begin
				interface5_bank_bus_dat_r <= csrbank5_scratch0_w;
			end
			2'd2: begin
				interface5_bank_bus_dat_r <= csrbank5_bus_errors_w;
			end
		endcase
	end
	if (csrbank5_reset0_re) begin
		reset_storage[1:0] <= csrbank5_reset0_r;
	end
	reset_re <= csrbank5_reset0_re;
	if (csrbank5_scratch0_re) begin
		scratch_storage[31:0] <= csrbank5_scratch0_r;
	end
	scratch_re <= csrbank5_scratch0_re;
	bus_errors_re <= csrbank5_bus_errors_re;
	...
	if (csrbank6_r_enable0_re) begin
		r_enable_storage <= csrbank6_r_enable0_r;
	end
	r_enable_re <= csrbank6_r_enable0_re;
	if (csrbank6_r_width0_re) begin
		r_width_storage[31:0] <= csrbank6_r_width0_r;
	end
	r_width_re <= csrbank6_r_width0_re;
	if (csrbank6_r_period0_re) begin
		r_period_storage[31:0] <= csrbank6_r_period0_r;
	end
	r_period_re <= csrbank6_r_period0_re;
	if (csrbank6_g_enable0_re) begin
		g_enable_storage <= csrbank6_g_enable0_r;
	end
	g_enable_re <= csrbank6_g_enable0_re;
	if (csrbank6_g_width0_re) begin
		g_width_storage[31:0] <= csrbank6_g_width0_r;
	end
	g_width_re <= csrbank6_g_width0_re;
	if (csrbank6_g_period0_re) begin
		g_period_storage[31:0] <= csrbank6_g_period0_r;
	end
	g_period_re <= csrbank6_g_period0_re;
	if (csrbank6_b_enable0_re) begin
		b_enable_storage <= csrbank6_b_enable0_r;
	end
	b_enable_re <= csrbank6_b_enable0_re;
	if (csrbank6_b_width0_re) begin
		b_width_storage[31:0] <= csrbank6_b_width0_r;
	end
	b_width_re <= csrbank6_b_width0_re;
	if (csrbank6_b_period0_re) begin
		b_period_storage[31:0] <= csrbank6_b_period0_r;
	end
	b_period_re <= csrbank6_b_period0_re;
	...
	if (csrbank7_out0_re) begin
		leds_storage[2:0] <= csrbank7_out0_r;
	end
	...
	if (csrbank8_sel) begin
		case (interface8_bank_bus_adr[8:0])
			1'd0: begin
				interface8_bank_bus_dat_r <= csrbank8_pos0_w;
			end
		endcase
	end
	if (csrbank8_pos0_re) begin
		servo_cntrl_storage[1:0] <= csrbank8_pos0_r;
	end
	servo_cntrl_re <= csrbank8_pos0_re;
	...
	if (csrbank10_sel) begin
		case (interface10_bank_bus_adr[8:0])
			1'd0: begin
				interface10_bank_bus_dat_r <= csrbank10_temperature_w;
			end
		endcase
	end
	temp_signal_re <= csrbank10_temperature_re;
	...
	if (csrbank11_sel) begin
		case (interface11_bank_bus_adr[8:0])
			...
			2'd3: begin
				interface11_bank_bus_dat_r <= csrbank11_update_value0_w;
			end
			3'd4: begin
				interface11_bank_bus_dat_r <= csrbank11_value_w;
			end
			3'd5: begin
	...
	if (csrbank11_load0_re) begin
		timer_load_storage[31:0] <= csrbank11_load0_r;
	end
	timer_load_re <= csrbank11_load0_re;
	if (csrbank11_reload0_re) begin
		timer_reload_storage[31:0] <= csrbank11_reload0_r;
	end
	timer_reload_re <= csrbank11_reload0_re;
	if (csrbank11_en0_re) begin
		timer_en_storage <= csrbank11_en0_r;
	end
	timer_en_re <= csrbank11_en0_re;
	if (csrbank11_update_value0_re) begin
		timer_update_value_storage <= csrbank11_update_value0_r;
	end
	timer_update_value_re <= csrbank11_update_value0_re;
	timer_value_re <= csrbank11_value_re;
	timer_status_re <= csrbank11_ev_status_re;
	if (csrbank11_ev_pending_re) begin
		timer_pending_r <= csrbank11_ev_pending_r;
	end
	timer_pending_re <= csrbank11_ev_pending_re;
	if (csrbank11_ev_enable0_re) begin
		timer_enable_storage <= csrbank11_ev_enable0_r;
	end
	timer_enable_re <= csrbank11_ev_enable0_re;
	interface12_bank_bus_dat_r <= 1'd0;
	if (csrbank12_sel) begin
		case (interface12_bank_bus_adr[8:0])
			1'd0: begin
				interface12_bank_bus_dat_r <= uart_rxtx_w;
			end
			1'd1: begin
			...
			3'd6: begin
				interface12_bank_bus_dat_r <= csrbank12_txempty_w;
			end
			3'd7: begin
				interface12_bank_bus_dat_r <= csrbank12_rxfull_w;
			end
		endcase
	end
	uart_txfull_re <= csrbank12_txfull_re;
	uart_rxempty_re <= csrbank12_rxempty_re;
	uart_status_re <= csrbank12_ev_status_re;
	if (csrbank12_ev_pending_re) begin
		uart_pending_r[1:0] <= csrbank12_ev_pending_r;
	end
	uart_pending_re <= csrbank12_ev_pending_re;
	if (csrbank12_ev_enable0_re) begin
		uart_enable_storage[1:0] <= csrbank12_ev_enable0_r;
	end
	uart_enable_re <= csrbank12_ev_enable0_re;
	uart_txempty_re <= csrbank12_txempty_re;
	uart_rxfull_re <= csrbank12_rxfull_re;
	interface13_bank_bus_dat_r <= 1'd0;
	if (csrbank13_sel) begin
		case (interface13_bank_bus_adr[8:0])
			1'd0: begin
				interface13_bank_bus_dat_r <= csrbank13_control_sig0_w;
			end
		endcase
	end
	if (csrbank13_control_sig0_re) begin
		valvula_cntrl_storage <= csrbank13_control_sig0_r;
	end
	valvula_cntrl_re <= csrbank13_control_sig0_re;
	if (sys_rst) begin
		reset_storage <= 2'd0;
		reset_re <= 1'd0;
		...
		b_period_re <= 1'd0;
		pwm__1 <= 1'd0;
		PWM_enable_storage <= 1'd0;
		PWM_enable_re <= 1'd0;
		PWM_width_re <= 1'd0;
		PWM_period_re <= 1'd0;
		servo_cntrl_storage <= 2'd0;
		servo_cntrl_re <= 1'd0;
		temp_signal_re <= 1'd0;
		valvula_cntrl_storage <= 1'd0;
		valvula_cntrl_re <= 1'd0;
		MQ3_signal_re <= 1'd0;
		Sal_nivel1_re <= 1'd0;
		Sal_nivel_temp_re <= 1'd0;
		GPIOverilog_cntrl_done_re <= 1'd0;
		GPIOverilog_cntrl_valor_led_storage <= 1'd0;
		GPIOverilog_cntrl_valor_led_re <= 1'd0;
		GPIOverilog_cntrl_ok_pending <= 1'd0;
		GPIOverilog_cntrl_ok_trigger_d <= 1'd0;
		GPIOverilog_cntrl_status_re <= 1'd0;
		GPIOverilog_cntrl_pending_re <= 1'd0;
		GPIOverilog_cntrl_pending_r <= 1'd0;
		GPIOverilog_cntrl_enable_storage <= 1'd0;
		GPIOverilog_cntrl_enable_re <= 1'd0;
		grant <= 1'd0;
		slave_sel_r <= 4'd0;
		count <= 20'd1000000;
...
servo_p servo_p(
	.clk(sys_clk),
	.pos(servo_cntrl_storage),
	.servo_o(servo_n1_servo_o)
);

temperatura temperatura(
	.clk(sys_clk),
	.rst_n(sys_rst),
	.data_temp(temp_n1_data_temp),
	.temperature(temp_signal_status)
);

Valvula Valvula(
	.control_sig(valvula_cntrl_storage),
	.sal_val(valvula_pin1_sal_val)
);

MQ3 MQ3(
	.Alcohol_ent(MQ3_pin1_Alcohol_ent),
	.Alcohol_sal(MQ3_signal_status)
);

Nivel_agua Nivel_agua(
	.Ent_nivel0(Nivel_pin1_Ent_nivel0),
	.Ent_nivel1(Nivel_pin1_Ent_nivel1),
	.clk(sys_clk),
	.Sal_nivel1(Sal_nivel1_status),
	.Sal_nivel_temp(Sal_nivel_temp_status)
);

GPIOv GPIOv(
	.clk(sys_clk),
	.rst(sys_rst),
	.valor_led(GPIOverilog_cntrl_valor_led_storage),
	.done(GPIOverilog_cntrl_done_status),
	.salida_led(mod_pin_verilog1_salida_led),
	.xclk(mod_pin_verilog1_xclk)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2022-11-24 11:07:00.
//------------------------------------------------------------------------------
