...
/* PWM */
#define CSR_PWM_BASE (CSR_BASE + 0x2000L)
#define CSR_PWM_ENABLE_ADDR (CSR_BASE + 0x2000L)
...
#define CSR_PWM_WIDTH_ADDR (CSR_BASE + 0x2004L)
...
#define CSR_PWM_PERIOD_ADDR (CSR_BASE + 0x2008L)
...
/* servo_cntrl */
#define CSR_SERVO_CNTRL_BASE (CSR_BASE + 0x2800L)
#define CSR_SERVO_CNTRL_POS_ADDR (CSR_BASE + 0x2800L)
#define CSR_SERVO_CNTRL_POS_SIZE 1
static inline uint32_t servo_cntrl_pos_read(void) {
	return csr_read_simple((CSR_BASE + 0x2800L));
}
static inline void servo_cntrl_pos_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x2800L));
}

/* temp_signal */
#define CSR_TEMP_SIGNAL_BASE (CSR_BASE + 0x3000L)
#define CSR_TEMP_SIGNAL_TEMPERATURE_ADDR (CSR_BASE + 0x3000L)
#define CSR_TEMP_SIGNAL_TEMPERATURE_SIZE 1
static inline uint32_t temp_signal_temperature_read(void) {
	return csr_read_simple((CSR_BASE + 0x3000L));
}

/* valvula_cntrl */
#define CSR_VALVULA_CNTRL_BASE (CSR_BASE + 0x3800L)
#define CSR_VALVULA_CNTRL_CONTROL_SIG_ADDR (CSR_BASE + 0x3800L)
#define CSR_VALVULA_CNTRL_CONTROL_SIG_SIZE 1
static inline uint32_t valvula_cntrl_control_sig_read(void) {
	return csr_read_simple((CSR_BASE + 0x3800L));
}
static inline void valvula_cntrl_control_sig_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x3800L));
}

/* MQ3_signal */
#define CSR_MQ3_SIGNAL_BASE (CSR_BASE + 0x4000L)
#define CSR_MQ3_SIGNAL_ALCOHOL_SAL_ADDR (CSR_BASE + 0x4000L)
#define CSR_MQ3_SIGNAL_ALCOHOL_SAL_SIZE 1
static inline uint32_t MQ3_signal_Alcohol_sal_read(void) {
	return csr_read_simple((CSR_BASE + 0x4000L));
}

/* Nivel_sig */
#define CSR_NIVEL_SIG_BASE (CSR_BASE + 0x4800L)
#define CSR_NIVEL_SIG_SAL_NIVEL1_ADDR (CSR_BASE + 0x4800L)
#define CSR_NIVEL_SIG_SAL_NIVEL1_SIZE 1
static inline uint32_t Nivel_sig_Sal_nivel1_read(void) {
	return csr_read_simple((CSR_BASE + 0x4800L));
}
#define CSR_NIVEL_SIG_SAL_NIVEL_TEMP_ADDR (CSR_BASE + 0x4804L)
#define CSR_NIVEL_SIG_SAL_NIVEL_TEMP_SIZE 1
static inline uint32_t Nivel_sig_Sal_nivel_temp_read(void) {
	return csr_read_simple((CSR_BASE + 0x4804L));
}

/* GPIOverilog_cntrl */
#define CSR_GPIOVERILOG_CNTRL_BASE (CSR_BASE + 0x5000L)
#define CSR_GPIOVERILOG_CNTRL_DONE_ADDR (CSR_BASE + 0x5000L)
#define CSR_GPIOVERILOG_CNTRL_DONE_SIZE 1
static inline uint32_t GPIOverilog_cntrl_done_read(void) {
	return csr_read_simple((CSR_BASE + 0x5000L));
}
#define CSR_GPIOVERILOG_CNTRL_VALOR_LED_ADDR (CSR_BASE + 0x5004L)
#define CSR_GPIOVERILOG_CNTRL_VALOR_LED_SIZE 1
static inline uint32_t GPIOverilog_cntrl_valor_led_read(void) {
	return csr_read_simple((CSR_BASE + 0x5004L));
}
static inline void GPIOverilog_cntrl_valor_led_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x5004L));
}
#define CSR_GPIOVERILOG_CNTRL_EV_STATUS_ADDR (CSR_BASE + 0x5008L)
#define CSR_GPIOVERILOG_CNTRL_EV_STATUS_SIZE 1
static inline uint32_t GPIOverilog_cntrl_ev_status_read(void) {
	return csr_read_simple((CSR_BASE + 0x5008L));
}
#define CSR_GPIOVERILOG_CNTRL_EV_STATUS_OK_OFFSET 0
#define CSR_GPIOVERILOG_CNTRL_EV_STATUS_OK_SIZE 1
static inline uint32_t GPIOverilog_cntrl_ev_status_ok_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t GPIOverilog_cntrl_ev_status_ok_read(void) {
	uint32_t word = GPIOverilog_cntrl_ev_status_read();
	return GPIOverilog_cntrl_ev_status_ok_extract(word);
}
#define CSR_GPIOVERILOG_CNTRL_EV_PENDING_ADDR (CSR_BASE + 0x500cL)
#define CSR_GPIOVERILOG_CNTRL_EV_PENDING_SIZE 1
static inline uint32_t GPIOverilog_cntrl_ev_pending_read(void) {
	return csr_read_simple((CSR_BASE + 0x500cL));
}
static inline void GPIOverilog_cntrl_ev_pending_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x500cL));
}
#define CSR_GPIOVERILOG_CNTRL_EV_PENDING_OK_OFFSET 0
#define CSR_GPIOVERILOG_CNTRL_EV_PENDING_OK_SIZE 1
static inline uint32_t GPIOverilog_cntrl_ev_pending_ok_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t GPIOverilog_cntrl_ev_pending_ok_read(void) {
	uint32_t word = GPIOverilog_cntrl_ev_pending_read();
	return GPIOverilog_cntrl_ev_pending_ok_extract(word);
}
static inline uint32_t GPIOverilog_cntrl_ev_pending_ok_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void GPIOverilog_cntrl_ev_pending_ok_write(uint32_t plain_value) {
	uint32_t oldword = GPIOverilog_cntrl_ev_pending_read();
	uint32_t newword = GPIOverilog_cntrl_ev_pending_ok_replace(oldword, plain_value);
	GPIOverilog_cntrl_ev_pending_write(newword);
}
#define CSR_GPIOVERILOG_CNTRL_EV_ENABLE_ADDR (CSR_BASE + 0x5010L)
#define CSR_GPIOVERILOG_CNTRL_EV_ENABLE_SIZE 1
static inline uint32_t GPIOverilog_cntrl_ev_enable_read(void) {
	return csr_read_simple((CSR_BASE + 0x5010L));
}
static inline void GPIOverilog_cntrl_ev_enable_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x5010L));
}
#define CSR_GPIOVERILOG_CNTRL_EV_ENABLE_OK_OFFSET 0
#define CSR_GPIOVERILOG_CNTRL_EV_ENABLE_OK_SIZE 1
static inline uint32_t GPIOverilog_cntrl_ev_enable_ok_extract(uint32_t oldword) {
	uint32_t mask = ((uint32_t)(1 << 1)-1);
	return ( (oldword >> 0) & mask );
}
static inline uint32_t GPIOverilog_cntrl_ev_enable_ok_read(void) {
	uint32_t word = GPIOverilog_cntrl_ev_enable_read();
	return GPIOverilog_cntrl_ev_enable_ok_extract(word);
}
static inline uint32_t GPIOverilog_cntrl_ev_enable_ok_replace(uint32_t oldword, uint32_t plain_value) {
	uint32_t mask = ((uint32_t)(1 << 1)-1);
	return (oldword & (~(mask << 0))) | (mask & plain_value)<< 0 ;
}
static inline void GPIOverilog_cntrl_ev_enable_ok_write(uint32_t plain_value) {
	uint32_t oldword = GPIOverilog_cntrl_ev_enable_read();
	uint32_t newword = GPIOverilog_cntrl_ev_enable_ok_replace(oldword, plain_value);
	GPIOverilog_cntrl_ev_enable_write(newword);
}

/* ctrl */
#define CSR_CTRL_BASE (CSR_BASE + 0x5800L)
#define CSR_CTRL_RESET_ADDR (CSR_BASE + 0x5800L)
...
#define CSR_CTRL_SCRATCH_ADDR (CSR_BASE + 0x5804L)
...
#define CSR_CTRL_BUS_ERRORS_ADDR (CSR_BASE + 0x5808L)
