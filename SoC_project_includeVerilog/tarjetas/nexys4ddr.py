...
# infrarrojo
#   ("infrarrojo", 0, Pins("C17"), IOStandard("LVCMOS33")),
#    ("infrarrojo", 1, Pins("D18"), IOStandard("LVCMOS33")),
#   ("infrarrojo", 2, Pins("E18"), IOStandard("LVCMOS33")),
#   ("infrarrojo", 3, Pins("G17"), IOStandard("LVCMOS33")),

# pwm
    ("pwm__", 1, Pins("V14"), IOStandard("LVCMOS33")),

#GPIOVerilog
    ("mod_pin_verilog", 1,
        Subsignal("xclk", Pins("V12")),
        Subsignal("salida_led", Pins("V11")),
        IOStandard("LVCMOS33")),
#temperatura

#Servo
	("servo_n", 1,
        Subsignal("servo_o", Pins("D14")),
        IOStandard("LVCMOS33")),
	
	("temp_n", 1,
        Subsignal("data_temp", Pins("F16")), 
        IOStandard("LVCMOS33")),
        
        ("valvula_pin", 1,
        Subsignal("sal_val", Pins("G16")), 
        IOStandard("LVCMOS33")),
        
        ("MQ3_pin", 1,
        Subsignal("Alcohol_ent", Pins("C17")), 
        IOStandard("LVCMOS33")),
        
        ("Nivel_pin", 1,
        Subsignal("Ent_nivel0", Pins("D18")), 
        Subsignal("Ent_nivel1", Pins("E18")), 
        IOStandard("LVCMOS33")),
